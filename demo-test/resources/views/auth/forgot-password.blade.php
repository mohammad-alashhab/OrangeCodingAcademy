<x-guest-layout>
    ...
    <div class="page-container" data-theme="light">
        ...
        <div class="login-container" style="max-width: 600px; margin: auto;">
            <div class="form-section">
                ...
                <form method="POST" action="{{ route('password.email') }}">
                    ...
                    <div class="input-group">
                        <input type="email" id="email" name="email" class="input-field" required autofocus autocomplete="username" placeholder="Email address" value="{{ old('email') }}" />
