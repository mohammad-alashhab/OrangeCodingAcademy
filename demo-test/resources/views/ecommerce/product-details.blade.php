<x-ecommerce-app-layout>
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="product__media--preview__items">
                                        <!-- Front Image -->
                                        <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="{{ asset('storage/' . $product->images->front_img) }}">
                                            <img class="single__product--thumbnail__img" src="{{ asset('storage/' . $product->images->front_img) }}" alt="{{ $product->name }} - Front View">
                                        </a>

                                        <!-- Back Image -->
                                        @if ($product->images->back_img)
                                        <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="{{ asset('storage/' . $product->images->back_img) }}" style="display: none;">
                                            <img class="single__product--thumbnail__img" src="{{ asset('storage/' . $product->images->back_img) }}" alt="{{ $product->name }} - Back View">
                                        </a>
                                        @endif

                                        <!-- Side Image -->
                                        @if ($product->images->side_img)
                                        <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="{{ asset('storage/' . $product->images->side_img) }}" style="display: none;">
                                            <img class="single__product--thumbnail__img" src="{{ asset('storage/' . $product->images->side_img) }}" alt="{{ $product->name }} - Side View">
                                        </a>
                                        @endif
                                        <div class="product__media--view__icon">
                                            <!-- Single Icon for Lightbox Gallery -->
                                            <a class="product__media--view__icon--link glightbox" href="{{ asset('storage/' . $product->images->front_img) }}" data-gallery="product-media-zoom">
                                                ...
                                                <span class="visually-hidden">View Product Images</span>
                                            </a>

                                            <!-- Hidden Links for Additional Images in the Gallery -->
                                            @if ($product->images->back_img)
                                            <a class="glightbox" href="{{ asset('storage/' . $product->images->back_img) }}" data-gallery="product-media-zoom" style="display: none;"></a>
                                            @endif
                                            @if ($product->images->side_img)
                                            <a class="glightbox" href="{{ asset('storage/' . $product->images->side_img) }}" data-gallery="product-media-zoom" style="display: none;"></a>
                                            @endif
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="product__media--nav__items">
                                        <img class="single__product--nav__thumbnail object-cover h-24 w-24" src="{{ asset('storage/' . $product->images->front_img) }}" alt="{{ $product->name }} - Front Image">
                                    </div>
                                </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="product__media--nav__items">
                                        <img class="single__product--nav__thumbnail object-cover h-24 w-24" src="{{ asset('storage/' . $product->images->back_img) }}" alt="{{ $product->name }} - Back Image">
                                    </div>
                                </div>
                                @endif
                                ...
                                <div class="swiper-slide">
                                    <div class="product__media--nav__items">
                                        <img class="single__product--nav__thumbnail object-cover h-24 w-24" src="{{ asset('storage/' . $product->images->side_img) }}" alt="{{ $product->name }} - Side Image">
                                    </div>
                                </div>
                                @endif
                                @else
                                <div class="swiper-slide">
                                    <div class="product__media--nav__items">
                                        <img class="single__product--nav__thumbnail object-cover h-24 w-24" src="{{ asset('path/to/default/image.webp') }}" alt="Default Image">
                                    </div>
                                </div>
                                @endif
                            </div>
                    ...
                    <div class="product__details--info">
                        <form action="#">
                            ...
                            <div class="product__variant">
                                ...
                                $cartItem = Auth::check() ? Auth::user()->carts->where('product_id', $product->id)->first() : null;
                                @endphp
                                ...
                                <div class="product__variant--list quantity d-flex align-items-center mb-20">
                                    <div class="quantity__box">
                                        ...
                                        <label>
                                            <input type="number" class="quantity__number quickview__value--number" value="{{ $isInCart ? $cartItem->quantity : 1 }}" data-counter />
                                        </label>
                                        <button type="button" class="quantity__value quickview__value--quantity increase" aria-label="quantity value" value="Increase Value">+</button>
                                    </div>

                                    <a class="primary__btn quickview__cart--btn" href="{{ $isInCart ? route('cart.remove', ['product_id' => $product->id]) : route('cart.add', ['product_id' => $product->id]) }}" title="{{ $isInCart ? 'Remove from Cart' : 'Add to Cart' }}">
                                ...
                                <div class="product__variant--list mb-15">
                                    ...
                                    <a class="variant__wishlist--icon mb-15" href="{{ $isInWishlist ? route('wishlist.remove', ['product_id' => $product->id]) : route('wishlist.add', ['product_id' => $product->id]) }}" title="{{ $isInWishlist ? 'Remove from Wishlist' : 'Add to Wishlist' }}">
                            ...
                            <div id="reviews" class="tab_pane">
                                <div class="product__reviews">
                                    <div class="product__reviews--header">
                                        ...
                                        <div class="reviews__ratting d-flex align-items-center">
                                            <ul class="rating d-flex">
                                                <!-- Display average rating stars dynamically -->
                                                @for($i = 1; $i <= 5; $i++)
                                                    <li class="rating__list">
                                                    <span class="rating__icon">
                                                        @if($averageRating >= $i)
                                    ...
                                    <div class="reviews__comment--area">
                                        ...
                                        @if ($review->is_visible) <!-- Check if the review is visible -->
                                        <div class="reviews__comment--list d-flex">
                                            <div class="reviews__comment--thumb">
                                                <!-- Display user image if available -->
                                                <img src="{{ asset('storage/' . $review->user->image) ?? '../assets/img/other/comment-thumb1.webp' }}" alt="comment-thumb">
                                            </div>
                                            <div class="reviews__comment--content">
                                                <div class="reviews__comment--top d-flex justify-content-between">
                                                    <div class="reviews__comment--top__left">
                                                        <h3 class="reviews__comment--content__title h4">{{ $review->user->name }}</h3>
                                                        <ul class="rating d-flex">
                                                            <!-- Display rating stars for each review -->
                                                            @for ($i = 1; $i <= 5; $i++)
                                                                <li class="rating__list">
                                                                <span class="rating__icon">
                                                                    @if ($i <= $review->rating)
                                                    ...
                                                    <span class="reviews__comment--content__date">{{ $review->created_at->format('F j, Y') }}</span>
                                                </div>
                                    ...
                                    <div id="writereview" class="reviews__comment--reply__area">
                                        <form id="reviewForm" action="{{ route('reviews.store') }}" method="POST">
                                            ...
                                            <div class="reviews__ratting mb-20">
                                                <ul class="rating rating-input--rating d-flex">
                                                    @for ($i = 1; $i <= 5; $i++)
                                                        <li class="rating__list">
                                                        <span class="rating__icon rating__icon-rated" data-rating="{{ $i }}">
                                                            <svg width="14" height="13" viewBox="0 0 14 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                <path d="M6.08398 0.921875L4.56055 4.03906L1.11523 4.53125C0.505859 4.625 0.271484 5.375 0.716797 5.82031L3.17773 8.23438L2.5918 11.6328C2.49805 12.2422 3.1543 12.7109 3.69336 12.4297L6.76367 10.8125L9.81055 12.4297C10.3496 12.7109 11.0059 12.2422 10.9121 11.6328L10.3262 8.23438L12.7871 5.82031C13.2324 5.375 12.998 4.625 12.3887 4.53125L8.9668 4.03906L7.41992 0.921875C7.16211 0.382812 6.36523 0.359375 6.08398 0.921875Z" fill="currentColor" />
                                                            </svg>
                                                        </span>
                                                ...
                                                <input type="hidden" name="rating" id="rating-input--rating" value="0">
                                            </div>
                                            <div class="row">
                                        ...
                                        <div id="reviewSuccessMessage" class="alert alert-success mt-3" style="display: none;"></div>
                                        <div id="reviewErrorMessage" class="alert alert-danger mt-3" style="display: none;"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="swiper-slide">
                        <article class="product__card">
                            <div class="product__card--thumbnail">
                                <a class="product__card--thumbnail__link display-block" href="{{ route('product-details.ecommerce', $relatedProduct->id) }}">
                                    <img class="product__card--thumbnail__img product__primary--img" src="{{ asset('storage/' . $relatedProduct->images->front_img) }}" alt="{{ $relatedProduct->name }}">
                                    <img class="product__card--thumbnail__img product__secondary--img" src="{{ asset('storage/' . $relatedProduct->images->back_img) }}" alt="{{ $relatedProduct->name }}">
                                </a>
                                @if($relatedProduct->discounts->isNotEmpty())
                                <span class="product__badge">-{{ $relatedProduct->discounts->first()->percentage }}%</span>
                                @endif
                            ...
                            <div class="product__card--content">
                                <ul class="rating product__card--rating d-flex">
                                    @php
                                    $relatedProductRating = $relatedProduct->reviews->avg('rating') ?? 0;
                                    @endphp
                                    @for($i = 1; $i <= 5; $i++)
                                        <li class="rating__list">
                                        <span class="rating__icon">
                                            @if($relatedProductRating >= $i)
                                            <!-- Full Star -->
                                            <svg width="14" height="13" viewBox="0 0 14 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M6.08398 0.921875L4.56055 4.03906L1.11523 4.53125C0.505859 4.625 0.271484 5.375 0.716797 5.82031L3.17773 8.23438L2.5918 11.6328C2.49805 12.2422 3.1543 12.7109 3.69336 12.4297L6.76367 10.8125L9.81055 12.4297C10.3496 12.7109 11.0059 12.2422 10.9121 11.6328L10.3262 8.23438L12.7871 5.82031C13.2324 5.375 12.998 4.625 12.3887 4.53125L8.9668 4.03906L7.41992 0.921875C7.16211 0.382812 6.36523 0.359375 6.08398 0.921875Z" fill="currentColor" />
                                            </svg>
                                            @elseif($relatedProductRating > $i - 1)
                                            <!-- Half Star -->
                                            <svg width="14" height="13" viewBox="0 0 14 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M6.78906 1.25L5.07812 4.71875L1.25781 5.28125L4.02344 7.95312L3.36719 11.75L6.78906 9.96875V1.25Z" fill="currentColor" />
                                                <path d="M12.4141 4.53125L8.99219 4.03906L7.44531 0.921875C7.1875 0.382812 6.39062 0.359375 6.10938 0.921875L4.58594 4.03906L1.14062 4.53125C0.53125 4.625 0.296875 5.375 0.742188 5.82031L3.20312 8.23438L2.61719 11.6328C2.52344 12.2422 3.17969 12.7109 3.71875 12.4297L6.78906 10.8125L9.83594 12.4297C10.375 12.7109 11.0312 12.2422 10.9375 11.6328L10.3516 8.23438L12.8125 5.82031C13.2578 5.375 13.0234 4.625 12.4141 4.53125ZM9.53125 7.95312L10.1875 11.75L6.78906 9.96875L3.36719 11.75L4.02344 7.95312L1.25781 5.28125L5.07812 4.71875L6.78906 1.25L8.47656 4.71875L12.2969 5.28125L9.53125 7.95312Z" fill="currentColor" />
                                        ...
                                        @endfor
                                        <li>
                                            <span class="rating__review--text">({{ $relatedProduct->reviews->count() }} Review{{ $relatedProduct->reviews->count() > 1 ? 's' : '' }})</span>
                                        </li>
                                </ul>
                                <h3 class="product__card--title"><a href="{{ route('product-details.ecommerce', $relatedProduct->id) }}">{{ $relatedProduct->name }}</a></h3>
                                <div class="product__card--price">
                                    <span class="current__price">${{ $relatedProduct->price }}</span>
                                    @if($relatedProduct->original_price)
                                    <span class="old__price">${{ $relatedProduct->original_price }}</span>
                                    @endif
                                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            const ratingIcons = document.querySelectorAll('.rating__icon-rated');
            const ratingInput = document.getElementById('rating-input--rating');
            ...
            ratingIcons.forEach(icon => {
                icon.addEventListener('click', function() {
                    ...
                    ratingIcons.forEach((star, index) => {
            ...
            reviewForm.addEventListener('submit', function(e) {
                ...
                fetch(this.action, {
                    ...
                    .then(response => {
                        if (!response.ok) {
                            return response.json().then(err => Promise.reject(err)); // Parse JSON for non-OK responses
                        }
                    ...
                    .then(data => {
                        ...
                        if (data.success) {
                            reviewSuccessMessage.textContent = data.message;
                            reviewSuccessMessage.style.display = 'block';
                            reviewErrorMessage.style.display = 'none';
                            reviewForm.reset(); // Reset the form fields after success
                        } else {
                    ...
                    .catch(error => {
                        ...
                        if (error.errors) {
                            ...
                            reviewErrorMessage.textContent = Object.values(error.errors).join(' ');
                        } else if (error.message) {
                            // Handle authentication errors (e.g., "You must be logged in")
                            reviewErrorMessage.textContent = error.message;
                        } else {
                            // Handle other errors
                            reviewErrorMessage.textContent = 'There was an error submitting your review. Please try again.';
                        }
                        reviewErrorMessage.style.display = 'block';
                        reviewSuccessMessage.style.display = 'none';
                    });
