<x-ecommerce-app-layout>
        ...
        <div class="container">
            ...
            <div class="main__contact--area position__relative">
                <div class="contact__form">
                    ...
                    <form class="contact__form--inner" id="contactForm" action="{{ route('contact-us.store') }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-lg-6 col-md-6">
                                <div class="contact__form--list mb-20">
                                    ...
                                    <div id="firstnameError" class="text-red-500 text-sm mt-1"></div> <!-- Error message container -->
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6">
                                <div class="contact__form--list mb-20">
                                    ...
                                    <div id="lastnameError" class="text-red-500 text-sm mt-1"></div> <!-- Error message container -->
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6">
                                <div class="contact__form--list mb-20">
                                    <label class="contact__form--label" for="input3">Phone Number <span class="contact__form--label__star">*</span></label>
                                    <input class="contact__form--input" name="number" id="input3" placeholder="Phone number" type="text" required>
                                    <div id="numberError" class="text-red-500 text-sm mt-1"></div> <!-- Error message container -->
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6">
                                <div class="contact__form--list mb-20">
                                    ...
                                    <div id="emailError" class="text-red-500 text-sm mt-1"></div> <!-- Error message container -->
                                </div>
                            </div>
                            <div class="col-12">
    ...
    <div class="contact__map--area section--padding pt-0">
        <iframe class="contact__map--iframe" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d4404.595617092092!2d35.90975840428313!3d31.97020848338788!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x151ca1dd7bca79dd%3A0x9b0416f056ff0786!2sOrange%20Digital%20Village!5e0!3m2!1sar!2sjo!4v1734519425220!5m2!1sar!2sjo" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    </div>
    ...
    <script>
        ...
        // Event listener to validate fields live on input
        document.getElementById('input1').addEventListener('input', validateFirstName);
        document.getElementById('input2').addEventListener('input', validateLastName);
        document.getElementById('input3').addEventListener('input', validatePhoneNumber);
        document.getElementById('input4').addEventListener('input', validateEmail);
        ...
        function validatePhoneNumber() {
            const phoneNumber = document.getElementById('input3').value;
            ...
            // Check if phone number was less than 10 digits
            ...
            fetch(this.action, {
                ...
                .then(data => {
                    ...
                    if (data.success) {
                        ...
                        document.getElementById('contactForm').reset(); // Reset the form fields after success
                    } else {
