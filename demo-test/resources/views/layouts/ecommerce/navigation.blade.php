<header class="header__section">
        ...
        <div class="container-fluid">
            <div class="main__header--inner position__relative d-flex justify-content-between align-items-center">
                ...
                <div class="main__logo">
                    <h1 class="main__logo--title"><a class="main__logo--link" href="index-2.html"><img class="main__logo--img" src="../assets/img/logo/nav-log.webp" alt="logo-img"></a></h1>
                </div>
                <div class="header__menu style3 d-none d-lg-block">
                    <nav class="header__menu--navigation">
                        <ul class="header__menu--wrapper d-flex">
                            <li class="header__menu--items">
                                <a class="header__menu--link {{ request()->routeIs('ecommerce') ? 'active' : '' }}" href="{{ route('ecommerce') }}">Home</a>
                            </li>
                            <li class="header__menu--items mega__menu--items">
                                <a class="header__menu--link {{ request()->routeIs('shop.ecommerce') ? 'active' : '' }}" href="{{ route('shop.ecommerce') }}">Shop</a>
                            </li>
                            <li class="header__menu--items">
                                <a class="header__menu--link {{ request()->routeIs('about-us.ecommerce') ? 'active' : '' }}" href="{{ route('about-us.ecommerce') }}">About Us</a>
                            </li>
                            <li class="header__menu--items">
                                <a class="header__menu--link {{ request()->routeIs('contact-us.ecommerce') ? 'active' : '' }}" href="{{ route('contact-us.ecommerce') }}">Contact</a>
                            </li>
                        </ul>
                    </nav>
                </div>
                <div class="header__account">
                    <ul class="header__account--wrapper d-flex align-items-center">
                        ...
                        <li class="header__menu--items header__minicart--items">
                            ...
                            <ul class="header__sub--menu" style="left: -125px; width: 175px;">
                                <!-- <li class="header__sub--menu__items">
                                    <a href="#" class="header__sub--menu__link">My Orders</a>
                                </li> -->
                                <li class="header__sub--menu__items">
                                    <a href="{{ route('profile.edit.ecommerce') }}" class="header__sub--menu__link">My Account</a>
                                </li>
                                <li class="header__sub--menu__items">
                        ...
                        <li class="header__account--items d-none d-lg-block">
                            <a class="header__account--btn" href="{{ route('wishlist.ecommerce') }}">
                                ...
                                <span class="items__count">{{ $wishlistCount }}</span>
                            </a>
                        </li>
                        <li class="header__account--items d-none d-lg-block">
                            <a class="header__account--btn" href="{{ route('cart.ecommerce') }}">
    ...
    <div class="offCanvas__minicart">
        ...
        <div class="minicart__conditions text-center">
            ...
            <label class="minicart__conditions--label" for="accept">I agree with the <a class="minicart__conditions--link" href="{{ route('privacy-policy.ecommerce') }}">Privacy Policy</a></label>
        </div>
        <div class="minicart__button d-flex justify-content-center">
            <a class="primary__btn minicart__button--link" href="{{ route('cart.ecommerce') }}">View cart</a>
            <a class="primary__btn minicart__button--link" href="{{ route('checkout.ecommerce') }}">Checkout</a>
        </div>
    </div>
